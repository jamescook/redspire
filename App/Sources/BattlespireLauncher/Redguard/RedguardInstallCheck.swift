...
/// Redguard to certify a version against (see REDGUARD.md), and GOG's own
/// REDGUARD.EXE has changed MD5 across time without that being shown to
/// matter. So this just checks the install is actually complete, not that
/// it's a specific certified build.
